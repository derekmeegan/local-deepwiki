...
/** Locate the packaged skill/SKILL.md (works from dist/ and from src/ during dev). */
export function packagedSkillPath(): string {
  ...
  throw new Error('Bundled skill/SKILL.md not found in the local-deepwiki package.');
}
